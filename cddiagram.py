# File adapted from the scripts used in: *Ismail Fawaz, H., Forestier, G., Weber, J. et al. Deep learning for time series classification: a review. Data Min Knowl Disc 33, 917--963 (2019). https://doi.org/10.1007/s10618-019-00619-1*

# Available in: https://github.com/hfawaz/cd-diagram
...
def wilcoxon_holm(alpha=0.05, df_perf=None):
    ...
    for i in range(m - 1):
        ...
        for j in range(i + 1, m):
            ...
            if np.array_equal(perf_1,perf_2):
                perf_1[0]=perf_1[0]-0.001
                perf_2[-1]=perf_2[-1]-0.001
